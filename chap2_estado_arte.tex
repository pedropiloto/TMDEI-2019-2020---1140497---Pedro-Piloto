...
Esta ferramenta disponibiliza a funcionalidade de executar pedidos contra interfaces de aplicação \emph{\acrshort{REST}} através da configuração dos seguintes parâmetros\cite{jmeter}:
\begin{itemize}
