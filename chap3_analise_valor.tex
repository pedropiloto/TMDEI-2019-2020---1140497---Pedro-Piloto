...
Os projetos que serão analisados são aqueles que foram abordados com maior destaque no estado da arte (\emph{c.f. secção \ref{section_modelos_descentralizados}}): \emph{Solid}, \emph{Blockstack}, \emph{Diaspora} e \emph{Elastos}.
...
O conceito introduzido pelo Solid, em conjunto com o possível potencial de escalabilidade, permite tornar o conceito de “\emph{Web} Descentralizada” numa realidade.

\section{Proposta de Valor}
Para estudar da proposta de valor serão utilizados o modelo \emph{\acrshort{FAST}} e o modelo de negócio Canvas.

\subsection{Modelo \emph{\acrshort{FAST}}}
...
A sua estrutura conta com nove blocos pré-definidos que permitem, de forma visual, criar ou adaptar um modelo já existente\cite{alexander:2006}.
\begin{figure}[h]
    \begin{center}
    % Requires \usepackage{graphicx}
